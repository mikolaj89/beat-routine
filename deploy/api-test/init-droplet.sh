...
echo ""
echo "Next steps:"
echo "  1. Set GitHub Actions secrets: DROPLET_HOST, DROPLET_USER, DROPLET_SSH_KEY_B64, DB_URL, JWT_ACCESS_SECRET"
echo "  2. Push to main or run the 'Deploy test API' workflow"
echo "  3. Open http://<droplet-ip>:8000/health"
